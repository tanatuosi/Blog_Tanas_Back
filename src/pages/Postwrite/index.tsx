...
import { Button, message, Upload, Input, notification } from 'antd';
...
const Postwrite: React.FC = () => {
  ...
  const {toTitle='', toTitleEng='', toTags=[], toCategory='', toDate='', tocontent= '<p>hello world</p>'} = server_id;
      ...
      <div className={s.body}>
        <div className={s.content}>
            ...
            <div className={s.details}>
              ...
              <div className={s.tags}>
                <div>权限：</div>
                <TagSelect value={permission} type={''} className={s.tagsselect} onChange={(e) => {setPermission(e)}} />
              </div>
            </div>
        </div>
            <div className={s.confirm}>
              ...
              <Button className={s.post} onClick={addconsole}>
                读取草稿
              </Button>
              <Button className={s.post} onClick={addArticle}>
                发布
              </Button>
            </div>
      </div>
